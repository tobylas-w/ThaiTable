...
export const isIntegrationEnabled = (integration: keyof typeof integrationConfig) => {
...
export const getIntegrationConfig = (integration: keyof typeof integrationConfig) => {
