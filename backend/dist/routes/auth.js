...
import { z } from 'zod';
import { authenticateToken, comparePassword, generateRefreshToken, generateToken, hashPassword, requireRole } from '../middleware/auth';
...
// Change password
router.put('/change-password', authenticateToken, validateRequest(changePasswordSchema), asyncHandler(async (req, res) => {
...
router.get('/users/:restaurantId', authenticateToken, requireRole(['ADMIN', 'MANAGER', 'OWNER']), asyncHandler(async (req, res) => {
